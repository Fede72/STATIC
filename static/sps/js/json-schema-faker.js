...
(function (global, factory) {
  ...
  defaults.defaultRandExpMax = 0;
  defaults.ignoreProperties = [];
  defaults.ignoreMissingRefs = false;
  defaults.failOnInvalidTypes = false;
  defaults.failOnInvalidFormat = false;
  defaults.alwaysFakeOptionals = true;
  ...
  defaults.maxLength = 0;
  defaults.resolveJsonPath = false;
  defaults.reuseProperties = false;
  defaults.fillProperties = false;
